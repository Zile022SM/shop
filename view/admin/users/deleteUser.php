	 ...
	 <div id="page-wrapper">
	            ...
	            <div class="container">
				  ...
				  <div class="offset-3">
				    ...
				    <h2><b><i><?php echo $user['name']." ".$user['last_name'];?></i></b></h2>
				  </div>
				  <br>
				  <div class="offset-3">
				  <form method="post" action="routes.php">
				      <input type="hidden" name="userId" value="<?php echo $user['admin_id'];?>">
                      <input style="background: green;" class="btn btn-success" type="submit" name="page" value="Delete user">
                      <input type="hidden" name="userId" value="<?php echo $user['admin_id'];?>">
                      <input style="background: red;" class="btn btn-danger" type="submit" name="page" value="Cancel">
                   </form>
                   </div>
				  </div>
				</div>
