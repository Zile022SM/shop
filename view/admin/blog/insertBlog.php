          ...
          <div class="col-lg-6 offset-3">
            <form role="form" action="routes.php" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <input class="form-control" type="text" name="title" value="<?php if (!empty($price)){echo $price;}?>" placeholder="Enter title">
                <?php 
              ...
              <div class="form-group">
                ...
                <textarea class="form-control" id="editor1" name="text"><?php echo isset($formData["description"]) ? htmlspecialchars($formData["description"]) : "";?></textarea>
                <?php 
              ...
              <br>
              <div class="submit">
              <input type="submit"  name="page" value="Insert Blog" class="btn btn-default">
              </div>
            </form>
            <script>
