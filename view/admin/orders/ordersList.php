	 ...
	 <div id="page-wrapper">
	            <div class="container">
                    ...
                    <div class="panel panel-default">
                        <p class="offset-3" style="font-size:20px;"><i class="fas fa-search"></i> search by date</p>
                        <form action="routes.php" method="post" class="form-inline offset-3">
						    <div class="form-group col-md-4 ">
						      <select name="date" class="form-control">
						        <option value="">--Choose date--</option>
						        <?php foreach ($ordersDate as $value){?>
						        <option value="<?php echo $value['date'];?>"><?php echo $value['date'];?></option>
						        <?php }?>
						      </select>
						    </div>
						  <input type="submit"  class="btn btn-primary" name="page" value="Go!">
						</form>
						<br><br><br>
                        <div class="panel-body">
                            ...
                            ?> 
	                          <div class="offset-3">
	                          <img style="height:400px;width:400px;" src="http://ask.oberlo.com/assets/images/1259-vItEGkjCCxPgiRxk.png" alt="" / class="img-thumbnail">
	                          </div>
                            <?php 	
                            }else{
			                   ...
			                   <ul class="pagination">
					                    <?php
					                        for ($i = 1; $i <= $totalNumberOfPages; $i++) {
					                            ...
					                            ?>
					                                <li class="<?php echo $classActive; ?>"><a href="routes.php?page=ordersList&currentPage=<?php echo $i; ?>" class="page-link"> <?php echo $i; ?> <span class="sr-only">(current)</span></a></li>
					                            <?php
					                        }
					                    ?>
					             </ul>
