...
$subcategories=isset($subcategories)?$subcategories:"";
                                ...
                                <tbody>
	                                <?php foreach ($subcategories as $value) { ?>
	                                    ...
	                                    <tr class="odd gradeX" style="text-align:center;">
	                                        <td><?php echo "<b>".ucfirst(strtolower($value['cat_name']))." / </b> ".$value['sub_name'];?></td>
	                                        <td  style="color:orange;"><a class="dropdown-item fas fa-edit" href="routes.php?page=ShowEditSubcategory&catId=<?php echo $value['id'];?>&subId=<?php echo $value['sub_id'];?>" style="color:orange;"></a></td>
	                                        <td  style="color:red;"><a class="dropdown-item fas fa-trash-alt" href="routes.php?page=deleteSubcategory&subId=<?php echo $value['sub_id'];?>" style="color:red;"></td>
	                                    </tr>
	                                 <?php }?>
                                </tbody>
                            </table>
