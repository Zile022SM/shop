...
$subCatName=isset($subCatName)?$subCatName:"";
          ...
          <div class="col-lg-6 offset-3">
            ...
            <form role="form" action="routes.php" method="post">
              ...
              <div class="form-group">
                ...
                <input class="form-control" type="text" name="subcategory_name" value="<?php if (!empty($subCatName)){echo $subCatName;}?>" placeholder="Enter category name">
             ...
             <div class="submit">
              <input type="submit"  name="page" value="Insert Subcategory" class="btn btn-default">
             </div>
            </form>
